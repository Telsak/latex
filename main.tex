...
men vi kom snabbt fram tll att vi ville göra en i full storlek, ca 170 cm högt. Det material som valdes var 19 mm MDF skiva, plexiglas
...
%till de verktyg eller utrymme som krävdes. Detta löstes genom att Magnus Åbergsgymnasiets (MÅG) byggprogram tillfrågades och genom 
%deras kompetens fick vi delarna precis så som vi ville ha dem.
...
\begin{figure}[!h]
\centering\includegraphics[width=.7\textwidth]{physicalview}
...
\begin{tabular}{ ||c|c|c|| }
 \hline
 \textbf{Chassi} & \textbf{Hårdvara} & \textbf{Övrigt} \\ [0.5ex]
 \hline\hline
...
\begin{tabular}{ ||l|l|l|l|| } 
 \hline
 \multicolumn{2}{||c|}{\textbf{Player}} & \multicolumn{2}{|c||}{\textbf{Highscore}}  \\
 \hline
 \textbf{Fält} & \textbf{Förklaring} & \textbf{Fält} & \textbf{Förklaring} \\
 \hline\hline
...
Då vi var sex personer delade vi upp arbetet enligt dess natur (hårdvara, mjukvara, hemsida etc) och delade därefter upp ansvarsområdet 
...
\textsc{Simon Olofsson, Olof Ivarsson, Madeleine Karlsson, \\
Patrick Lundin, Sara Andersson, Emrik Olsson \\
NTK17 Högskolan Väst, Nov 2017 - Jan 2018}
\end{document}