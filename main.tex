...
%Nu finns användarinformation och kopplat kort-ID lagrat i databasen.
...
oss, om arkadmaskiner generellt samt om spelet som vi hade med. Hemsidan med sitt stilrena utseende fick i navigeringsfältet inspiration av arkadmaskinen genom att navigeringsknapparna blev 
