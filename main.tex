...
Arkadmaskinen består av flera entiteter som tillsammans skapar arkadsystemet. Den fysiska vyn i Fig. \ref{fig_physview} visar informationsflödet 
...
skapa en snyggare övergång mellan skärmen och kontrollbrädans kanter. Tabell \ref{table_material} listar allt material och Fig \ref{fig_material} är de utsågade delarna.
...
ändringar direkt på arkadmaskinen. Databasen är uppbyggd av två tabeller (se Fig. \ref{fig_databas}): player och highscore.
\clearpage
...
alternativet. Att vi gjorde valet med att sätta plexiglas på kontrollbrädan var för att det gav ett mer autentiskt intryck.

\begin{figure}[h]
\centering\includegraphics[width=.6\textwidth]{kontrollpanel}
